...
namespace EcommerceWeb.Controllers
{
    public class DiscountController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,BeforeDiscountPrice,DiscountPercentage,Date")] Discount discount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BeforeDiscountPrice,DiscountPercentage,Date")] Discount discount)
        {
            if (id != discount.Id)
            {
                return NotFound();
