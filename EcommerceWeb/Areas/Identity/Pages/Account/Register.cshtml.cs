...
namespace EcommerceWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IEmailSender _emailSender; //change ka qetu
        ...
        public RegisterModel(
            ...
            IUnitOfWork unitOfWork) //change qetu
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Role fixing here , if not selected make it automatically customer
